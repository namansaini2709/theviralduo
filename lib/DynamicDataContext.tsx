...
const INITIAL_DATA: DynamicData = {
  ...
  brands: [
    { id: 1, name: "FOF Fitness", logo: "/brands/FOF Fitnesa logo.jpeg" },
    { id: 2, name: "Global Holidays", logo: "/brands/Global Holidays.PNG" },
    { id: 3, name: "Make your trip possible", logo: "/brands/Make your trip possible.jpg" },
    { id: 4, name: "Sharma ji ke bhature", logo: "/brands/Sharma ji ke bhature.JPG" },
    { id: 5, name: "Shri radhey Krishna jewellers", logo: "/brands/Shri radhey Krishna  jewellers.JPG" },
    { id: 6, name: "VDMC", logo: "/brands/Vdmc logo.JPG" },
    { id: 7, name: "Anytime Fitness", logo: "/brands/anytime. fitness logos.JPG" },
    { id: 8, name: "Career Launcher", logo: "/brands/carrer launcher.JPG" },
    { id: 9, name: "MS Classes", logo: "/brands/ms classes.JPG" },
    { id: 10, name: "Saral Gym", logo: "/brands/saral gym logo.jpg" },
  ],
  results: [
